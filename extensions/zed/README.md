...
Ayatsumugi native bundle separately, keep its sidecar and Ayatori core together,
and make `ayatsumugi-mcp` available on `PATH`.

The sidecar is not included in this Apache-2.0 repository.
